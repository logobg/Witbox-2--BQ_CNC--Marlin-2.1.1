...
#define CONFIG_EXAMPLES_DIR "BQ/Witbox_2"
...
/**
 * BQ Witbox 2 Configuration
 *
 * This configuration supports the standard Witbox 2 with or without
 * heated bed
 *
 * Enable WITBOX2_HEATED_BED in Configuration_adv.h for all functionality
...
#define STRING_CONFIG_H_AUTHOR "logobg" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BQ_CNC
#endif
...
#define CUSTOM_MACHINE_NAME "BQ Witbox 2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 82.10
  #define DEFAULT_bedKi 6.60
  #define DEFAULT_bedKd 681.8
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 210.02 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 7, 120 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34, 15, -5.04 }
...
#define HOMING_FEEDRATE_MM_M { (120*60), (120*60), (80*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_Z_FEEDRATE   80   // (mm/s) Z axis feedrate (not used for delta printers)
#endif
