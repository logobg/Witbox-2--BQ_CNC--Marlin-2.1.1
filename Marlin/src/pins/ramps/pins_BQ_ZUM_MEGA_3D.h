...
//
// Z Probe (when not Z_MAX_PIN)
//
#ifndef Z_MAX_PROBE_PIN
  #define Z_MAX_PROBE_PIN                     19  // Z-MAX Label
#endif
...
#define MOSFET_C_PIN                          10  // LIGHT_PIN
#define MOSFET_D_PIN                           7  // FAN_BLOCK_PIN
#define FAN_BOX_PIN                            2  // +++ WASN'T in the file !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11
